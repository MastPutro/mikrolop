        ...
        <div className="min-h-screen bg-gray-100 flex">
            ...
            >
                ...
                <nav className="mt-6 px-4 space-y-2">
                    ...
                    <Link
                        href={route('manajemen.teknisi.index')}
                        className={`flex items-center px-4 py-3 rounded-lg transition-colors ${route().current('manajemen.teknisi.index')
                            ? 'bg-gray-100 text-gray-900'
                            : 'text-gray-600 hover:bg-gray-50'
                            }`}
                    >
                        ...
                        <span className={`ms-4 ${!sidebarOpen && 'hidden'}`}>Manajemen Teknisi</span>
                    </Link>
